...
The first 8 bits of the filter IPv4 address in Integer Format (e.g., 127)

Default value: `0`

### `--b`

The second 8 bits of the filter IPv4 address in Integer Format (e.g., 0)

Default value: `0`

### `--c`

The third 8 bits of the filter IPv4 address in Integer Format (e.g., 0)

Default value: `0`

### `--d`

The last 8 bits of the filter IPv4 address in Integer Format (e.g., 1)
